...
A variable `x` shouldn't be too foreign of a concept. However, in mathematical notation it is common for subscripts to distinctly describe different versions of that variable. 
